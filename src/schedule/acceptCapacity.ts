...
export function decideGroupCapacity(
  ...
  cap: number,
  /** Active metric unit for user-facing reason strings — defaults to words mode
   *  so all existing callers stay byte-for-byte identical. */
  unit: EffortUnit = WORDS_UNIT,
