...
- **SC-007** *(conditional on RP-4 — the mechanism is met, the outcome is not yet)*: A lost race **never** produces an operational alert and **never** halts the loop, demonstrated by a failure-mode test.
